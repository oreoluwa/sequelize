...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    if (['sqlite', 'rqlite'].includes(this.options.dialect) && this.options.timezone !== '+00:00') {
    ...
    switch (this.getDialect()) {
      ...
      case 'sqlite':
        ...
        break;
      case 'rqlite':
        Dialect = require('./dialects/rqlite');
        break;
      default:
        throw new Error(`The dialect ${this.getDialect()} is not supported. Supported dialects: mssql, mariadb, mysql, postgres, rqlite and sqlite.`);
    }
  ...
  random() {
    ...
    if (dia === 'postgres' || dia === 'sqlite' || dia === 'rqlite') {
